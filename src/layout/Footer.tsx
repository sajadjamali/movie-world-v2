...
const Footer: React.FC = () => {
    return (
        <div className="bg-gray-800 mt-auto flex flex-col md:flex-row items-center py-7 md:justify-around text-white">
            <SocialNetworks />
            <p className='text-center px-1 mt-5 md:mt-0 lg:text-lg'>All rights of the site belong to <span className='text-rose-500 font-bold italic'>Movie World</span></p>
